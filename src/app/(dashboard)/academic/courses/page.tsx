...
export default function CoursesPage() {
  ...
  const { courses, tasks, deleteCourse, isFirestoreReady } = useDataStore();
      ...
      <div className="space-y-5 sm:space-y-6 animate-in fade-in-50 duration-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="p-5 rounded-3xl bg-surface border border-border shadow-soft space-y-4">
