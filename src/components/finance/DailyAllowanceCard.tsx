...
import { Sparkles, TrendingDown, AlertTriangle, CheckCircle2, ShieldCheck, Flame, Utensils } from "lucide-react";
import { HealthyMealModal } from "./HealthyMealModal";
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2.5 py-1 rounded-full bg-[#E0FBF2] dark:bg-[#1E332A] text-[#1F8766] dark:text-[#7FE3C0] text-[10px] font-extrabold hover:scale-105 active:scale-95 transition-all flex items-center gap-1 border border-[#9EE9D0]/50"
              title="Rekomendasi Menu Makan Sehat Berbasis Sisa Jatah"
            >
